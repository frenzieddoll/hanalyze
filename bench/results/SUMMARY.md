...
| Rosenbrock_2D/SA | 160.0 | **39.4** | 0.25× | 1.9e-16 | 9.1e-12 | 0 | P42 で 2.7× 改善 (10×every-20) |
...
| Rosenbrock_10D/SA | 466.4 | **197.3** | 0.42× | 4.2e-16 | 1.9e-10 | 0 | P42 で 3.0× 改善 |
...
| Sphere_30D/SA | 1282 | **293.2** | 0.23× | **1.20e-40** | 9.5e-16 | 0 | P42 で 2.4× 改善 / 精度勝ち |
...
| Ackley_10D/SA | 620.4 | **153.7** | 0.25× | **4.4e-16** | 1.9e-08 | 0 | P42 で 3.1× 改善 / 8 桁勝ち |
...
| Griewank_10D/SA | 560.5 | **123.5** | 0.22× | **0** | 0.0074 | 0 | P42 で 2.3× 改善 / 精度勝ち |
...
| Levy_10D/SA | 503.9 | **173.4** | 0.34× | **6.4e-21** | 8.5e-12 | 0 | P42 で 2.3× 改善 |
...
| Rastrigin_10D/SA | 528.3 | **164.0** | 0.31× | **0** ⭐ | 9.95e-14 | 0 | P42 で 3.6× 改善 / 機械精度 |
...
| Schwefel_5D/SA | 289.0 | **49.6** | 0.17× | 2075 | 2075 | (両側同) | P42 で 2.5× 改善 |

**Python 勝ち**:
- **SA 全 8 問題**: hanalyze multi-start (10 runs × 10000 iter, LBFGS every 20) vs scipy `dual_annealing` の C 最適化 + 改善駆動 LBFGS。P42 で 2.3-3.6× 改善し差を 7-13× → 2-6× に縮めたが、構造的に Python の方が速い (改善駆動 LBFGS は別 phase で対処)
