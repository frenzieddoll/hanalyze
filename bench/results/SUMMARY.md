...
| KMeans_n2000_p5_k5 | 74.6 | **23.3** | 0.31× | 18532 | 18496 | inertia ≈ (P8 で 414→75 ms = **5.5× 改善**、sklearn 逆転は届かず) |
...
**Python 勝ち**: KMeans (P8 で 0.06×→0.31× に大幅改善も逆転届かず、Lloyd 全方位 SIMD)、DT (sklearn Cython tree split)。
...
| ml | KMeans_n2000_p5_k5 | **0.31×** | sklearn k-means++ + Cython (**P8 で 0.06×→0.31× 大幅縮小**、Lloyd 全方位 SIMD) |
