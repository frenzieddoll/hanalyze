"""earnings-earn_height (posteriordb) — PyMC 実装。
単純な線形回帰 (earn ~ height)。★2026-07-13: コード準備のみ (未実行)。
"""
import json
