...
各主成分の寄与率を棒グラフ (scree plot) で並べると、どこで寄与率が急減するか
(elbow) を視覚的に判断でき、保持すべき主成分数の目安が得られます。下図では PC1
が支配的で、PC2 以降の寄与が小さいことが分かります。

![PCA の scree plot (各主成分の寄与率バー・PC1 が支配的)](../images/pca-scree.svg)
