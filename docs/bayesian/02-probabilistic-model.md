...
> Related demos:
> - [`hbm-example`](../../hanalyze-demos/demo/bayesian/HBMExample.hs) — hierarchical normal model + 4-chain NUTS
> - [`hbm-regression`](../../hanalyze-demos/demo/bayesian/HBMRegressionDemo.hs) — Bayesian simple regression (HTML report via legacy `Hanalyze.Viz.AnalysisReport`)
> - [`clinical-trial`](../../hanalyze-demos/demo/bayesian/ClinicalTrial.hs) — Beta-Binomial A/B test
> - [`simpson-paradox`](../../hanalyze-demos/demo/bayesian/SimpsonParadoxDemo.hs) — LM/GLMM/HBM compared on Simpson's example
> - [`hbm-random-slope`](../../hanalyze-demos/demo/bayesian/HBMRandomSlopeDemo.hs) — random-slope extension
...
[`noncentered-demo`](../../hanalyze-demos/demo/bayesian/NonCenteredDemo.hs).
...
the two, see [`hbm-random-slope`](../../hanalyze-demos/demo/bayesian/HBMRandomSlopeDemo.hs).
...
The performance benchmark (`hanalyze-demos/bench/haskell/BenchHBMScaling.hs`, same models and
...
Demo: [`deterministic-demo`](../../hanalyze-demos/demo/bayesian/DeterministicDemo.hs).
