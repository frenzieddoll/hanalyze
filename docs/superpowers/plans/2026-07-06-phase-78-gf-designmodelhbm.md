...
- `src/Hanalyze/Fit.hs` — `designModelHBM` spec 型 + smart ctor + `Fit` instance + `DesignHBMFit` 型 + ModelP ビルダー。`designModelGP` (1422-1435) の直後に追加。export list に追記。
- `src/Hanalyze/Plot/ML.hs` — `instance MultiVarModel DesignHBMFit` (事後予測帯)。`instance MultiVarModel GPRegModelN` (1744) の直後に追加。
- `src/Hanalyze/Plot.hs` — re-export に `designModelHBM` / `ranIntercept` / `ranSlope` / `DesignHBMFit` を追記。
- `test/Hanalyze/Design/WorkflowSpec.hs` — fit/収束/帯/error の hspec。
...
**Files:**
- Modify: `src/Hanalyze/Fit.hs` (export list + 定義。`designModelGP` の直前あたり)
- Test: `test/Hanalyze/Design/WorkflowSpec.hs`
...
```bash
git add src/Hanalyze/Fit.hs test/Hanalyze/Design/WorkflowSpec.hs
...
**Files:**
- Modify: `src/Hanalyze/Plot/ML.hs` (`instance MultiVarModel GPRegModelN` (1744) の直後)
- Test: `test/Hanalyze/Design/WorkflowSpec.hs`
...
```bash
git add src/Hanalyze/Plot/ML.hs test/Hanalyze/Design/WorkflowSpec.hs
...
**Files:**
- Modify: `src/Hanalyze/Plot.hs` (re-export)
- Test: `test/Hanalyze/Design/WorkflowSpec.hs`
...
```bash
git add src/Hanalyze/Plot.hs test/Hanalyze/Design/WorkflowSpec.hs
