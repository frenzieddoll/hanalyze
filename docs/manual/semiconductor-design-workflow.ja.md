...
> 🌐 [English](semiconductor-design-workflow.md) | **日本語**
...
**対応コード**: `src/Hanalyze/Design/Custom/Factor.hs:1`
...
**対応コード**: `src/Hanalyze/Design/Custom/Factor.hs` の `DiscreteNum`
コンストラクタと、 `src/Hanalyze/Design/Optimal.hs` の探索集合構築部分
...
**対応コード**: `src/Hanalyze/Model/GLM.hs:1`, `src/Hanalyze/Model/AFT.hs:1`
...
**対応コード**:
- `Hanalyze.Design.Custom.Coordinate.CustomDesignSpec` (`src/Hanalyze/Design/Custom/Coordinate.hs:80` 付近)
...
> `centralComposite` が実装済 (`src/Hanalyze/Design/RSM.hs:1` で確認済)
...
- 対応コード: `src/Hanalyze/Design/DSD.hs:1`
...
**対応コード**: `src/Hanalyze/Design/Custom/Coordinate.hs:80`
...
**対応コード**: `src/Hanalyze/Design/Custom/Augment.hs:80`
...
**対応コード**: `src/Hanalyze/Design/SpaceFilling.hs:1`,
`src/Hanalyze/Stat/QuasiRandom.hs:1`
...
**対応コード**: `src/Hanalyze/Design/Orthogonal.hs:1`,
`src/Hanalyze/Design/Taguchi.hs:1`
...
**対応コード**: `src/Hanalyze/Stat/QuasiRandom.hs:1`,
`src/Hanalyze/Design/SpaceFilling.hs:1`
...
**対応コード**: `src/Hanalyze/Optim/BayesOpt.hs:1`, `src/Hanalyze/Model/GP.hs:1`
...
> (`src/Hanalyze/Optim/BayesOpt.hs:1`)
...
**対応コード**: `src/Hanalyze/Design/Anova.hs:1`, `src/Hanalyze/Design/Power.hs:1`
...
**対応コード**: `src/Hanalyze/Design/Custom/Constraint.hs:1`
...
**対応コード**: `src/Hanalyze/Design/Block.hs:1`, `src/Hanalyze/Design/Taguchi.hs:1`
...
**対応コード**: `src/Hanalyze/Model/GLM.hs:1`
...
**対応コード**: `src/Hanalyze/Design/RSM.hs:1`, `src/Hanalyze/Design/MultiRSM.hs:1`
...
> (`src/Hanalyze/Model/GP.hs:1` の `data Kernel` で確認)
...
**対応コード**: `src/Hanalyze/Model/GP.hs:1`,
`src/Hanalyze/Model/GradientBoosting.hs:1`, `src/Hanalyze/Viz/GP.hs:1`
...
**対応コード**: `src/Hanalyze/Optim/Desirability.hs:1`
...
**対応コード**: `src/Hanalyze/Optim/Pareto.hs:1`, `src/Hanalyze/Viz/Pareto.hs:1`
...
**対応コード根拠**: `src/Hanalyze/Design/DSD.hs:48-53`
