...
> [📚 索引](README.md) ｜ [01 quickstart](01-quickstart.md) ｜ [02 regression](02-regression.md) ｜ **03 bayesian-hbm** ｜ [04 multivariate](04-multivariate.md) ｜ [05 ml](05-ml.md) ｜ [06 timeseries](06-timeseries.md) ｜ [07 survival](07-survival.md) ｜ [08 causal](08-causal.md) ｜ [09 doe](09-doe.md) ｜ [10 stat](10-stat.md) ｜ [11 data](11-data.md) ｜ [12 plot](12-plot.md)
...
> モデルの DAG・plate 帰属の規律は [02-probabilistic-model](../bayesian/02-probabilistic-model.md)、
...
> [02-probabilistic-model パターン 4](../bayesian/02-probabilistic-model.md)、 funnel の診断は
...
[viz-diagnostics](../bayesian/viz-diagnostics.md) を参照。 draw の df 集計動詞は
[11 data](11-data.md) の Wrangle 節。
...
HTML (VegaLite) 経路の同等図は [viz-diagnostics](../bayesian/viz-diagnostics.md) を参照。
...
**同じ語彙** (`holdAt` / `byVar`、 [02-regression](02-regression.md)) で固定する (既定は非軸を
平均 `Mean` で固定):
...
**同じ語彙** `bandMode` ([02-regression](02-regression.md)) で観測ノイズ込みの **予測区間 (PI)** や
...
- 分布マップ: [01-distributions](../bayesian/01-distributions.md)
- モデル記述・DAG・plate: [02-probabilistic-model](../bayesian/02-probabilistic-model.md) / [plate-notation](../bayesian/plate-notation.ja.md)
- サンプラ (MH/HMC/NUTS/Gibbs/Slice): [03-mcmc-samplers](../bayesian/03-mcmc-samplers.md)
- モデル比較 (WAIC/LOO): [06-model-comparison](../bayesian/06-model-comparison.md)
- 診断図の作り方: [viz-diagnostics](../bayesian/viz-diagnostics.md)
