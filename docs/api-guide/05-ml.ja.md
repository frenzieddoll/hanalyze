...
[ml/usage-ml-extensions](../ml/usage-ml-extensions.ja.md) ・ [08-decisiontree](../regression/08-decisiontree.md) が一次根拠。
...
[10 stat の前処理節](10-stat.md#前処理-標準化-statstandardize) を参照。
